...
function Card (props) {
    ...
    return (
        <li className="elements__card">
            <img className="elements__card-image" src ={props.link} alt = {props.name} onClick={handleCardClick}/>
            ...
            <button className={cardDeleteButtonVisible}  type="button" aria-label="Корзина" onClick={handleCardDelete}></button>
        </li>
    );
}
