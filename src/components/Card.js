...
function Card (props) {
    ...
    return (
        <li className="elements__card">
            <img className="elements__card-image" style={{ backgroundImage: `url(${props.link})`, backgroundSize: 'cover'}} onClick={() => {handleCardClick ()}}/>
            <h2 className="elements__card-title">{props.name}</h2>
            <div className="elements__card-like">
                <button className="elements__card-like-button" type="button" aria-label="Лайк" onClick={() => {}}></button>
